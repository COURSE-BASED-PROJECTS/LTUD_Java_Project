...
INSERT INTO NGUOIDUNG(CMND,HOTEN,NAMSINH,TRANGTHAI,XA,HUYEN,TINH) -- NGUOILIENQUAN,NOICACHLY
	VALUES  ('0312614186', N'Nguyễn Văn An',1997,'F1',N'Phường 4',N'Quận 5',N'TP.HCM'),
			...
			('0745271814', N'Lê Hoàng Bảo Nam',1975,'F0',N'Thị Trấn Nam Phước',N'Huyện Duy Xuyên',N'Tỉnh Quảng Nam'),
			...
			('079277688937', N'Lê Nguyễn Phong Văn',2000,'F1',N'Phường Tân Định',N'Quận 1',N'TP.HCM'),
			('001970694310', N'Hoàng Ngọc Tường Vy',2001,'F1',N'Phường Mai Dịch', N'Quận Cầu Giấy',N'Thủ Đô Hà Nội'),
			('002410237306', N'Bùi Việt Anh',2002, 'F2',N'Xã Đạo Đức',N'Huyện Vị Xuyên',N'Tỉnh Hà Giang'),
			('079922364930', N'Văn Phú Quý',2003, N'Khỏi bệnh',N'Xã Xuân Thới Thượng',N'Huyện Hóc Môn',N'TP.HCM'),
			('044342420295', N'Hồ Văn Thiên Phúc',2004, 'F0',N'Xã Thanh Thạch',N'Huyện Tuyên Hóa',N'Tỉnh Quảng Bình'),
			('049481119954', N'Lý Thiên Anh',2005,'F0',N'Phường Cẩm Nam',N'TP.Hội An',N'Tỉnh Quảng Nam'),
			('051668760226', N'Phạm Gia Phong',2000, N'Khỏi bệnh',N'Thị Trấn Sông Vệ',N'Huyện Tư Nghĩa',N'Tỉnh Quảng Ngãi'),
			('060699033017', N'Trịnh Tư Dung',2001, 'F1',N'Xã La Dạ',N'Huyện Hàm Thuận Bắc',N'Tỉnh Bình Thuận'),
			('070111778334', N'Trần Lê Sang',2002, 'F2',N'Xã Thuận Lợi',N'Huyện Đồng Phú',N'Tỉnh Bình Phước')
GO
...
INSERT INTO TAIKHOAN(TAIKHOAN,MATKHAU,PHANHE,SODU,TINHTRANG) --DUNO
	VALUES  ('0312614186','1073d23e818eb7f5ed7c7b53bccbe243','NGUOIDUNG',3782644,1),
			...
			('079277688937','38416da37c62a91bd3533f9912d9666a','NGUOIDUNG',7715991,0),
			('001970694310','578adedc7f2f5a3b2f6fdf77b1ad3ba2','NGUOIDUNG',2099523,0),
			('002410237306','eb722ae5d8e9f614e22cc51688f50025','NGUOIDUNG',1439914,0),
...
INSERT INTO NHUYEUPHAM(MANYP,TENNYP,HSD,GIOIHANSL,GIATIEN)
	VALUES 	('NYP01',N'Gói Đồ đóng hộp','2023/01/01', 2, 120000),
			...
			('NYP06',N'Gói Sát khuẩn','2023/01/01', 5, 200000)
GO
...
INSERT INTO LSTRANGTHAI(CMND, TRANGTHAICU, TRANGTHAIMOI, THOIGIAN)
	VALUES	('0312614186', NULL, 'F2', '2021/12/30'),
			('0312614186', 'F2', 'F1', '2022/01/04'),

			('0191818716', NULL, 'F2', '2021/12/19'),
			('0191818716', 'F2', 'F1', '2022/01/07'),
			
			('0137692698', NULL, 'F2', '2021/12/19'),
			('0137692698', 'F2', 'F1', '2022/01/10'),

			('0342107164', NULL, 'F2', '2021/12/09'),
			('0342107164', 'F2', 'F1', '2021/12/14'),
			('0342107164', 'F1', 'F0', '2021/12/30'),
			('0342107164', 'F0', N'Khỏi bệnh', '2022/01/09'),

			('0809669861', NULL, 'F2', '2021/12/19'),
			('0809669861', 'F2', 'F1', '2022/01/06'),

			('0745271814', NULL, 'F2', '2021/12/19'),
			('0745271814', 'F2', 'F1', '2021/12/27'),
			('0745271814', 'F1', 'F0', '2022/01/08'),

			('0497492975',  NULL, 'F2', '2021/12/19'),
			('0497492975', 'F2', 'F1', '2021/12/20'),
			('0497492975', 'F1', 'F0', '2021/12/31'),
			('0497492975', 'F0', N'Khỏi bệnh', '2022/01/10'),

			('0528984542', NULL, 'F1', '2021/12/29'),
			('0528984542', 'F1', 'F0', '2022/01/09'),

			('0213489216', NULL, 'F1', '2022/01/07'),

			('079277688937', NULL, 'F2', '2021/12/29'),
			('001970694310', NULL, 'F2', '2021/12/26'),
			('002410237306', NULL, 'F2', '2021/12/26'),
			('079922364930', NULL, 'F2', '2021/12/25'),
			('044342420295', NULL, 'F2', '2021/12/29'),
			('049481119954', NULL, 'F2', '2021/12/29'),
			('051668760226', NULL, 'F2', '2021/12/29'),
			('060699033017', NULL, 'F2', '2021/12/29'),
			('070111778334', NULL, 'F2', '2021/12/26'),
			
			('079277688937', 'F2', 'F1', '2021/12/19'),
			('001970694310', 'F2', 'F1', '2021/12/27'),
			('079922364930', 'F2', 'F1', '2021/12/30'),
			('079922364930', 'F1', 'F0', '2021/12/31'),
			('079922364930', 'F0', N'Khỏi bệnh', '2021/01/10'),
			('044342420295', 'F2', 'F1', '2022/01/05'),
			('044342420295', 'F1', 'F0', '2022/01/07'),
			('049481119954', 'F2', 'F1', '2022/01/01'),
			('049481119954', 'F1', 'F0', '2022/01/06'),
			('051668760226', 'F2', 'F1', '2021/12/17'),
			('051668760226', 'F1', 'F0', '2021/12/27'),
			('051668760226', 'F0', N'Khỏi bệnh', '2022/01/10'),
			('060699033017', 'F2', 'F1', '2022/01/08')

GO

INSERT INTO LSMUAHANG(MAHD, CMND, LOAIHANG, SOLUONG, SOTIEN, THOIGIAN)
	VALUES	('C7311', '0191818716', 'NYP03', 2, 400000, '2021/01/12'),
			('D2946', '0809669861', 'NYP04', 1, 150000, '2021/04/02'),
			('A2555', '0213489216', 'NYP01', 1, 120000, '2021/05/30'),
			('B9089', '0745271814', 'NYP02', 1, 550000, '2021/07/23'),
			('B1214', '0137692698', 'NYP04', 1, 150000, '2021/09/11'),
			('C2057', '0342107164', 'NYP03', 2, 400000, '2021/10/21'),
			('A6627', '0528984542', 'NYP01', 2, 240000, '2021/11/22'),
			('D2938', '0213489216', 'NYP04', 1, 150000, '2021/12/29')
GO
...
UPDATE NGUOIDUNG
	SET NGUOILIENQUAN = '0528984542', NOICACHLY = 'KS003' WHERE CMND = '0312614186'
UPDATE NGUOIDUNG
	SET NGUOILIENQUAN = '0528984542', NOICACHLY = 'KS002' WHERE CMND = '0745271814'
UPDATE NGUOIDUNG
...
--UPDATE NGUOIDUNG		   
--	SET NGUOILIENQUAN = '0191818716', NOICACHLY = 'KS003' WHERE CMND = '079922364930'
--UPDATE NGUOIDUNG		   
--	SET NGUOILIENQUAN = '0191818716', NOICACHLY = 'KS003' WHERE CMND = '051668760226'

UPDATE NGUOIDUNG
	SET NGUOILIENQUAN = '049481119954', NOICACHLY = 'KS003' WHERE CMND = '079277688937'
UPDATE NGUOIDUNG		   
	SET NGUOILIENQUAN = '049481119954', NOICACHLY = 'KS003' WHERE CMND = '001970694310'
UPDATE NGUOIDUNG		   
	SET NGUOILIENQUAN = '001970694310', NOICACHLY = 'KS003' WHERE CMND = '002410237306'

UPDATE NGUOIDUNG		   
	SET NGUOILIENQUAN = '049481119954', NOICACHLY = 'KS006' WHERE CMND = '060699033017'
UPDATE NGUOIDUNG		   
	SET NGUOILIENQUAN = '060699033017', NOICACHLY = 'KS006' WHERE CMND = '070111778334'

UPDATE NGUOIDUNG
	SET NOICACHLY = 'BV001' WHERE CMND = '044342420295'
UPDATE NGUOIDUNG						  
	SET NOICACHLY = 'BV004' WHERE CMND = '049481119954'
