...
INSERT INTO TAIKHOAN(TAIKHOAN,MATKHAU,PHANHE, SODU) --DUNO
	VALUES  ('0312614186',NULL,'NGUOIDUNG',3782644),
			('0191818716','ndquan','NGUOIDUNG',2747664),
			('0137692698',NULL,'NGUOIDUNG',4923005),
			('0342107164',NULL,'NGUOIDUNG',2478551),
			('0809669861',NULL,'NGUOIDUNG',9058035),
			('0745271814',NULL,'NGUOIDUNG',7411665),
			('0497492975',NULL,'NGUOIDUNG',3090293),
			('0528984542',NULL,'NGUOIDUNG',8112845),
			('0213489216',NULL,'NGUOIDUNG',6586918),
			('QuanLyA','QuanLyA','QUANLY',NULL),
			('QuanTriThanhToan','NguoiThanhToan','QUANTRI',48370183),
			('QuanTriCOVID','COVID_19','QUANTRI',NULL),
			('A','A','QUANLY',NULL),
			('B','B','NGUOIDUNG',NULL),
			('C','C','QUANTRI',100000)
GO
